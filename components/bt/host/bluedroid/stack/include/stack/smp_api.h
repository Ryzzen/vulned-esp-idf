...
#define SMP_PEER_KEYPR_NOT_EVT 8 /* Peer keypress notification received event  \
                                  */
#define SMP_SC_OOB_REQ_EVT                                                     \
  9 /* SC OOB request event (both local and peer OOB data */
...
#define SMP_ENCR_KEY_SIZE_MIN 1
 ...
 * events occur.*/
typedef UINT8(tSMP_CALLBACK)(tSMP_EVT event, BD_ADDR bd_addr,
...
**
** Returns          SMP_STARTED if pairing started, otherwise reason for
*failure.
**
*******************************************************************************/
...
*requested
**                  res          - result of the operation SMP_SUCCESS if
*success
...
*******************************************************************************/
extern BOOLEAN SMP_Encrypt(UINT8 *key, UINT8 key_len, UINT8 *plain_text,
                           UINT8 pt_len, tSMP_ENC *p_out);

/*******************************************************************************
**
** Function         SMP_KeypressNotification
**
** Description      This function is called to notify SM about Keypress
*Notification.
**
