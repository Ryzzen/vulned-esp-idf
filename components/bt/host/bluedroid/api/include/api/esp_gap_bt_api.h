...
typedef enum {
  ...
  ESP_BT_SET_COD_SERVICE_CLASS =
      0x02, /*!< set the bits in the input, the current bit will remain */
  ESP_BT_CLR_COD_SERVICE_CLASS =
      0x04, /*!< clear the bits in the input, others will remain */
  ESP_BT_SET_COD_ALL = 0x08, /*!< overwrite major, minor, set the bits in
                                service class, reserved_2 remain unchanged */
  ESP_BT_INIT_COD = 0x0a,    /*!< overwrite major, minor, and service class,
                                reserved_2 remain unchanged */
  ESP_BT_SET_COD_RESERVED_2 =
      0x10, /*!< overwrite the two least significant bits reserved_2 whose
               default value is 0b00; other values of reserved_2 are invalid
               according to Bluetooth Core Specification 5.4 */
} esp_bt_cod_mode_t;
...
typedef enum {
  ESP_BT_GAP_DEV_PROP_BDNAME =
      1, /*!< Bluetooth device name, value type is int8_t [] */
  ESP_BT_GAP_DEV_PROP_COD,  /*!< Class of Device, value type is uint32_t */
  ESP_BT_GAP_DEV_PROP_RSSI, /*!< Received Signal strength Indication, value type
                               is int8_t, ranging from -128 to 127 */
...
#define ESP_BT_EIR_TYPE_FLAGS                                                  \
  0x01 /*!< Flag with information such as BR/EDR and LE support */
#define ESP_BT_EIR_TYPE_INCMPL_16BITS_UUID                                     \
  0x02 /*!< Incomplete list of 16-bit service UUIDs */
#define ESP_BT_EIR_TYPE_CMPL_16BITS_UUID                                       \
  0x03 /*!< Complete list of 16-bit service UUIDs */
#define ESP_BT_EIR_TYPE_INCMPL_32BITS_UUID                                     \
  0x04 /*!< Incomplete list of 32-bit service UUIDs */
#define ESP_BT_EIR_TYPE_CMPL_32BITS_UUID                                       \
  0x05 /*!< Complete list of 32-bit service UUIDs */
#define ESP_BT_EIR_TYPE_INCMPL_128BITS_UUID                                    \
  0x06 /*!< Incomplete list of 128-bit service UUIDs */
#define ESP_BT_EIR_TYPE_CMPL_128BITS_UUID                                      \
...
#define ESP_BT_EIR_TYPE_TX_POWER_LEVEL                                         \
  0x0a /*!< Tx power level, value is 1 octet ranging from  -127 to 127, unit   \
          is dBm*/
...
#define ESP_BT_ACL_DM1_ONLY                                                    \
  (ESP_BT_ACL_PKT_TYPES_MASK_DM1 | 0x330e) /* 0x330e */
#define ESP_BT_ACL_DH1_ONLY                                                    \
  (ESP_BT_ACL_PKT_TYPES_MASK_DH1 | 0x330e) /* 0x331e */
#define ESP_BT_ACL_DM3_ONLY                                                    \
  (ESP_BT_ACL_PKT_TYPES_MASK_DM3 | 0x330e) /* 0x370e */
#define ESP_BT_ACL_DH3_ONLY                                                    \
  (ESP_BT_ACL_PKT_TYPES_MASK_DH3 | 0x330e) /* 0x3b0e */
#define ESP_BT_ACL_DM5_ONLY                                                    \
  (ESP_BT_ACL_PKT_TYPES_MASK_DM5 | 0x330e) /* 0x730e */
#define ESP_BT_ACL_DH5_ONLY                                                    \
  (ESP_BT_ACL_PKT_TYPES_MASK_DH5 | 0x330e) /* 0xb30e */
#define ESP_BT_ACL_2_DH1_ONLY                                                  \
  (~ESP_BT_ACL_PKT_TYPES_MASK_NO_2_DH1 & 0x330e) /* 0x330c */
#define ESP_BT_ACL_3_DH1_ONLY                                                  \
  (~ESP_BT_ACL_PKT_TYPES_MASK_NO_3_DH1 & 0x330e) /* 0x330a */
#define ESP_BT_ACL_2_DH3_ONLY                                                  \
  (~ESP_BT_ACL_PKT_TYPES_MASK_NO_2_DH3 & 0x330e) /* 0x320e */
#define ESP_BT_ACL_3_DH3_ONLY                                                  \
  (~ESP_BT_ACL_PKT_TYPES_MASK_NO_3_DH3 & 0x330e) /* 0x310e */
#define ESP_BT_ACL_2_DH5_ONLY                                                  \
  (~ESP_BT_ACL_PKT_TYPES_MASK_NO_2_DH5 & 0x330e) /* 0x230e */
#define ESP_BT_ACL_3_DH5_ONLY                                                  \
  (~ESP_BT_ACL_PKT_TYPES_MASK_NO_3_DH5 & 0x330e) /* 0x130e */

typedef uint16_t esp_bt_acl_pkt_type_t;

/* Range of encryption key size */
#define ESP_BT_ENC_KEY_SIZE_CTRL_MAX (16)
#define ESP_BT_ENC_KEY_SIZE_CTRL_MIN (1)
...
/// EIR data content, according to "Supplement to the Bluetooth Core
/// Specification"
typedef struct {
  ...
  uint8_t flag; /*!< EIR flags, see ESP_BT_EIR_FLAG for details, EIR will not
...
typedef uint8_t esp_bt_pin_code_t[ESP_BT_PIN_CODE_LEN]; /*!< Pin Code (upto 128
                                                           bits) MSB is 0 */
...
#define ESP_BT_IO_CAP_OUT                                                      \
  0 /*!< DisplayOnly */ /* relate to BTM_IO_CAP_OUT in stack/btm_api.h */
#define ESP_BT_IO_CAP_IO                                                       \
  1 /*!< DisplayYesNo */ /* relate to BTM_IO_CAP_IO in stack/btm_api.h */
#define ESP_BT_IO_CAP_IN                                                       \
  2 /*!< KeyboardOnly */ /* relate to BTM_IO_CAP_IN in stack/btm_api.h */
#define ESP_BT_IO_CAP_NONE                                                     \
  3 /*!< NoInputNoOutput */ /* relate to BTM_IO_CAP_NONE in stack/btm_api.h */
...
typedef enum {
  ...
  ESP_BT_COD_MAJOR_DEV_UNCATEGORIZED =
...
typedef enum {
  ...
  ESP_BT_COD_MINOR_PERIPHERAL_COMBO =
      0x30,                                          /*!< Combo
                                                     ESP_BT_COD_MINOR_PERIPHERAL_KEYBOARD,
                                                     ESP_BT_COD_MINOR_PERIPHERAL_POINTING                                          and
                                                     ESP_BT_COD_MINOR_PERIPHERAL_COMBO can be OR'd with one of the
                                                     ...
                                                     ESP_BT_COD_MINOR_PERIPHERAL_SENSING_DEVICE
                                                      */
  ...
  ESP_BT_COD_MINOR_PERIPHERAL_DIGITIZING_TABLET =
      0x05,                                        /*!< Digitizing Tablet */
  ...
  ESP_BT_COD_MINOR_PERIPHERAL_HAND_GESTURAL_INPUT =
      0x09, /*!< Hand Gestural Input */
...
#define ESP_BT_ENC_MODE_AES                                                    \
  (0x02) /*!< Link Level Encryption is ON with AES-CCM */
...
typedef enum {
  ...
  ESP_BT_GAP_CFM_REQ_EVT,   /*!< Security Simple Pairing User Confirmation
                               request. */
  ...
  ESP_BT_GAP_REMOVE_BOND_DEV_COMPLETE_EVT, /*!< remove bond device complete
                                              event */
  ESP_BT_GAP_QOS_CMPL_EVT,                 /*!< QOS complete event */
  ESP_BT_GAP_ACL_CONN_CMPL_STAT_EVT, /*!< ACL connection complete status event
                                      */
  ESP_BT_GAP_ACL_DISCONN_CMPL_STAT_EVT, /*!< ACL disconnection complete status
                                           event */
...
#define ESP_BT_GAP_MIN_INQ_LEN                                                 \
  (0x01) /*!< Minimum inquiry duration, unit is 1.28s */
#define ESP_BT_GAP_MAX_INQ_LEN                                                 \
  (0x30) /*!< Maximum inquiry duration, unit is 1.28s */

/** Minimum, Default and Maximum poll interval **/
#define ESP_BT_GAP_TPOLL_MIN                                                   \
  (0x0006) /*!< Minimum poll interval, unit is 625 microseconds */
#define ESP_BT_GAP_TPOLL_DFT                                                   \
  (0x0028) /*!< Default poll interval, unit is 625 microseconds */
#define ESP_BT_GAP_TPOLL_MAX                                                   \
  (0x1000) /*!< Maximum poll interval, unit is 625 microseconds */
...
typedef union {
  ...
  struct disc_res_param {
    ...
    esp_bt_gap_dev_prop_t
        *prop; /*!< properties discovered from the new device */
  ...
  struct rmt_srvc_rec_param {
    esp_bd_addr_t bda;    /*!< remote bluetooth device address*/
    esp_bt_status_t stat; /*!< service search status */
  } rmt_srvc_rec; /*!< specific service record from remote device parameter
                     struct */
  ...
  struct read_rssi_delta_param {
    ...
    int8_t rssi_delta;    /*!< rssi delta value range -128 ~127, The value zero
                             indicates that the RSSI is inside the Golden Receive
                             Power Range, the Golden Receive Power Range is from
                             ESP_BT_GAP_RSSI_LOW_THRLD to
  ...
  struct config_eir_data_param {
    esp_bt_status_t
        stat;             /*!< config EIR status:
                              ESP_BT_STATUS_SUCCESS: config success
                              ESP_BT_STATUS_EIR_TOO_LARGE: the EIR data is more than 240B.
                             The EIR may not contain the whole data.             others: failed
                          */
    uint8_t eir_type_num; /*!< the number of EIR types in EIR type */
    esp_bt_eir_type_t
        eir_type[ESP_BT_EIR_TYPE_MAX_NUM]; /*!< EIR types in EIR type */
  ...
  struct bt_remove_bond_dev_cmpl_evt_param {
    esp_bd_addr_t bda; /*!< remote bluetooth device address*/
    esp_bt_status_t
        status; /*!< Indicate the remove bond device operation success status */
  } remove_bond_dev_cmpl; /*!< Event parameter of
  ...
  struct acl_disconn_cmpl_stat_param {
    ...
    uint16_t handle;        /*!< ACL connection handle */
    esp_bd_addr_t bda;      /*!< remote bluetooth device address */
  } acl_disconn_cmpl_stat;  /*!< ACL disconnection complete status parameter
                               struct */
...
/**
 * @brief           register callback function. This function should be called
...
/**
 * @brief           Set discoverability and connectability mode for legacy
 * bluetooth. This function should be called after esp_bluedroid_enable()
...
/**
 * @brief           This function starts Inquiry and Name Discovery. This
 * function should be called after esp_bluedroid_enable() completes
 * successfully. When Inquiry is halted and cached results do not contain device
 * name, then Name Discovery will connect to the peer target to get the device
 * name. esp_bt_gap_cb_t will be called with ESP_BT_GAP_DISC_STATE_CHANGED_EVT
 * when Inquiry is started or Name Discovery is completed. esp_bt_gap_cb_t will
 * be called with ESP_BT_GAP_DISC_RES_EVT each time the two types of discovery
 * results are got.
 *
 * @param[in]       mode - Inquiry mode
 *
 * @param[in]       inq_len - Inquiry duration in 1.28 sec units, ranging from
 * 0x01 to 0x30. This parameter only specifies the total duration of the Inquiry
 * process,
 *                          - when this time expires, Inquiry will be halted.
 *
 * @param[in]       num_rsps - Number of responses that can be received before
 * the Inquiry is halted, value 0 indicates an unlimited number of responses.
 *
 * @return
 *                  - ESP_OK : Succeed
 *                  - ESP_ERR_INVALID_STATE: if bluetooth stack is not yet
...
/**
 * @brief           Cancel Inquiry and Name Discovery. This function should be
 * called after esp_bluedroid_enable() completes successfully. esp_bt_gap_cb_t
 * will be called with ESP_BT_GAP_DISC_STATE_CHANGED_EVT if Inquiry or Name
 * Discovery is cancelled by calling this function.
 *
 * @return
 *                  - ESP_OK : Succeed
 *                  - ESP_ERR_INVALID_STATE: if bluetooth stack is not yet
...
/**
 * @brief           Start SDP to get remote services. This function should be
 * called after esp_bluedroid_enable() completes successfully. esp_bt_gap_cb_t
 * will be called with ESP_BT_GAP_RMT_SRVCS_EVT after service discovery ends.
 *
 * @return
 *                  - ESP_OK : Succeed
 *                  - ESP_ERR_INVALID_STATE: if bluetooth stack is not yet
...
/**
 * @brief           Start SDP to look up the service matching uuid on the remote
 * device. This function should be called after esp_bluedroid_enable() completes
 * successfully.
 *
 *                  esp_bt_gap_cb_t will be called with
 * ESP_BT_GAP_RMT_SRVC_REC_EVT after service discovery ends
 * @return
 *                  - ESP_OK : Succeed
 *                  - ESP_ERR_INVALID_STATE: if bluetooth stack is not yet
 * enabled
 ...
 * @param[out]      length - return the length of EIR data excluding fields of
 * length and data type
 *
 * @return          pointer of starting position of eir data excluding eir data
 * type, NULL if not found
 *
 */
uint8_t *esp_bt_gap_resolve_eir_data(uint8_t *eir, esp_bt_eir_type_t type,
                                     uint8_t *length);
 ...
 *
 *                  esp_bt_gap_cb_t will be called with
 * ESP_BT_GAP_CONFIG_EIR_DATA_EVT after config EIR ends.
 *
 ...
 *                  The structure esp_bt_gap_cb_t will be called with
 * ESP_BT_GAP_SET_COD_EVT after set COD ends. This function should be called
 * after Bluetooth profiles are initialized, otherwise the user configured class
 * of device can be overwritten. Some profiles have special restrictions on
 * class of device, and changes may make these profiles unable to work.
 *
 * @param[in]       cod - class of device
...
/**
 * @brief           This function is called to read RSSI delta by address after
 * connected. The RSSI value returned by ESP_BT_GAP_READ_RSSI_DELTA_EVT.
 *
 *
 * @param[in]       remote_addr - remote device address, corresponding to a
 * certain connection handle
 * @return
 *                  - ESP_OK : Succeed
 *                  - ESP_FAIL: others
 *
...
/**
 * @brief           Get the device number from the security database list of
 * peer device. It will return the device bonded number immediately.
 *
...
/**
 * @brief           Get the device from the security database list of peer
 * device. It will return the device bonded information immediately.
 *
 * @param[inout]    dev_num: Indicate the dev_list array(buffer) size as input.
 *                           If dev_num is large enough, it means the actual
 * number as output. Suggest that dev_num value equal to
 * esp_ble_get_bond_device_num().
 *
 * @param[out]      dev_list: an array(buffer) of `esp_bd_addr_t` type. Use for
 * storing the bonded devices address. The dev_list should be allocated by who
 * call this API.
 *
 * @return
 *                  - ESP_OK : Succeed
 ...
 *                                   If pin_type is ESP_BT_PIN_TYPE_VARIABLE,
 * pin_code and pin_code_len will be ignored, and ESP_BT_GAP_PIN_REQ_EVT will
 * come when control requests for pin code. Else, will use fixed pin code and
 * not callback to users.
 *
...
/**
 * @brief            Set a GAP security parameter value. Overrides the default
 * value.
 *
...
/**
 * @brief            Reply the key value to the peer device in the legacy
 * connection stage.
 *
 * @param[in]        bd_addr : BD address of the peer
 *
 ...
 *
 * @param[in]        passkey : passkey value, must be a 6 digit number, can be
 * lead by 0.
 *
 * @return           - ESP_OK : success
 *                   - ESP_ERR_INVALID_STATE: if bluetooth stack is not yet
...
/**
 * @brief            Reply the confirm value to the peer device in the legacy
 * connection stage.
 *
 * @param[in]        bd_addr : BD address of the peer device
 *
 ...
 *
 * @param[in]        channels :  The n th such field (in the range 0 to 78)
 * contains the value for channel n : 0 means channel n is bad. 1 means channel
 * n is unknown. The most significant bit is reserved and shall be set to 0. At
 * least 20 channels shall be marked as unknown.
 *
 * @return           - ESP_OK : success
 *                   - ESP_ERR_INVALID_STATE: if bluetooth stack is not yet
 * enabled
...
*
* @param[in]        remote_bda: The remote device's address
* @param[in]        t_poll:     Poll interval, the maximum time between
transmissions which from the master to a particular slave on the ACL logical
transport. unit is 0.625ms
*
* @return           - ESP_OK : success
*                   - ESP_ERR_INVALID_STATE: if bluetooth stack is not yet
enabled
 ...
 *                  after set page timeout ends. The value to be set will not be
 effective util the
 *                  next page procedure, it's suggested to set the page timeout
 before initiating
 *                  a connection.
 *
 * @param[in]       page_to: Page timeout, the maximum time the master will wait
 for a Base-band page response from the remote device at a locally initiated
 connection attempt. The valid range is 0x0016 ~ 0xffff, the default value is
 0x2000, unit is 0.625ms.
 *
 * @return          - ESP_OK: success
 *                  - ESP_ERR_INVALID_STATE: if bluetooth stack is not yet
 enabled
 ...
 *                  esp_bt_gap_cb_t will be called with
 * ESP_BT_GAP_GET_PAGE_TO_EVT after get page timeout ends
 *
 * @return          - ESP_OK: success
 *                  - ESP_ERR_INVALID_STATE: if bluetooth stack is not yet
 * enabled
